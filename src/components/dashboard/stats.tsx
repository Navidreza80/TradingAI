    ...
    <div
      className={`${i18n.language == "fa" && "font-vazirmatn"} ${
        i18n.language == "ar" && "font-notokufi"
                    ...
                    hover:shadow-xl hover:scale-102 hover:border-gray-300 dark:hover:border-gray-700 flex-grow`}
    >
        <div className="flex flex-row flex-wrap w-1/6 justify-center">
            <div className="flex flex-col items-center">
                <h1 className="w-8 h-8 bg-likes bg-cover"></h1>
                <h1 className="text-ellipsis whitespace-nowrap overflow-hidden">10 Likes</h1>
            </div>
        </div>
        <div className="flex flex-row flex-wrap w-1/5 justify-center">
            <div className="flex flex-col items-center">
                <h1 className="w-8 h-8 bg-user bg-cover"></h1>
                <h1 className="text-ellipsis whitespace-nowrap overflow-hidden">13 Following</h1>
            </div>
        </div>
        <div className="flex flex-row flex-wrap w-1/5 justify-center">
            <div className="flex flex-col items-center">
                <h1 className="w-8 h-8 bg-save bg-cover"></h1>
                <h1 className="text-ellipsis whitespace-nowrap overflow-hidden">30 Saved</h1>
            </div>
        </div>
        <div className="flex flex-row flex-wrap w-1/5 justify-center">
            <div className="flex flex-col items-center">
                <h1 className="w-8 h-8 bg-comments bg-cover"></h1>
                <h1 className="text-ellipsis whitespace-nowrap overflow-hidden">500 Comments</h1>
            </div>
        </div>
    </div>
  );
