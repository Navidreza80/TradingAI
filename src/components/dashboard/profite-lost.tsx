...
export function ProfitLost() {
  return (
    <div
      className="flex flex-row flex-wrap pr-2 py-4 border border-[#4b4b4b61] rounded-[16px] justify-start items-center bg-[#4b4b4b5b] gap-8 w-1/3 transition-all duration-300 
                    hover:shadow-xl hover:scale-102 hover:border-gray-300 dark:hover:border-gray-700"
    >
      <h2 className="text-green pr-6 pl-4 border-r border-[#ffffff7e] py-4 text-lg font-bold text-[#00FF40]">
        P&L
      </h2>
