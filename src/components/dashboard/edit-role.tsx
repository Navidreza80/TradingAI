  ...
  return (
    <Dialog>
      ...
      <DialogContent className="sm:max-w-[425px]">
        <DialogHeader>
          <DialogTitle className="dark:text-white text-gray-400">{t('dashboard.modals.role')}</DialogTitle>
          <DialogDescription>
          {t('dashboard.modals.roleDesc')}
          </DialogDescription>
        </DialogHeader>
        <div className="grid py-4">
          <div className="grid grid-cols-4 items-center gap-4">
            <Label htmlFor="username" className="text-right dark:text-white text-gray-400">
            {t('dashboard.modals.roleInput')}
            </Label>
            <Input id="username" defaultValue="Forex Trader" className="col-span-3" />
          </div>
        </div>{" "}
