...
export function MultimediaSection() {
  // Multi media mock data
  const multimedia = [
    {
      id: 1,
      title: "Understanding Stock Market Fundamentals",
      type: "video",
      thumbnail: "https://images.unsplash.com/photo-1611974789855-9c2a0a7236a3?ixlib=rb-4.0.3&auto=format&fit=crop&w=1000&q=80",
      duration: "15:24",
    ...
    },
    {
      ...
      type: "video",
      thumbnail: "https://images.unsplash.com/photo-1590283603385-17ffb3a7f29f?ixlib=rb-4.0.3&auto=format&fit=crop&w=1000&q=80",
      duration: "22:15",
      author: "Michael Chen"
    },
    {
      id: 3,
      title: "Weekly Stock Market Recap",
      type: "podcast",
      thumbnail: "https://images.unsplash.com/photo-1642052502780-8ee67c2c714c?ixlib=rb-4.0.3&auto=format&fit=crop&w=1000&q=80",
      duration: "35:10",
    ...
    },
    {
      ...
      type: "video",
      thumbnail: "https://images.unsplash.com/photo-1535320903710-d993d3d77d29?ixlib=rb-4.0.3&auto=format&fit=crop&w=1000&q=80",
      duration: "18:45",
        ...
        {multimedia.map((media) => (
          <div key={media.id} className="bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden">
            ...
            <div className="p-4">
              ...
              <Link
                href={`/learn/stocks/multimedia/${media.id}`}
