...
export default function StartTrading() {
  ...
  return (
    <section className="relative py-20 bg-gradient-to-b dark:from-[#1a1a1a] dark:to-[#0a0a0a] from-gray-50 to-white overflow-hidden">
      {/* Background Pattern */}
      <div
        className="absolute inset-0 bg-[radial-gradient(circle_at_50%_50%,rgba(24,144,255,0.1)_1px,transparent_1px)] 
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <h2
            className={`text-3xl sm:text-4xl lg:text-5xl font-bold p-3
          ...
          <p
            className={`mt-4 text-lg dark:text-gray-400 text-gray-600 max-w-3xl mx-auto 
        ...
        >
          <Link href="/trade">
            <button
              className={`px-8 py-4 bg-gradient-to-r from-[#1890ff] to-[#69c0ff]
