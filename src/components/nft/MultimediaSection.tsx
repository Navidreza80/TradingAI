...
export function MultimediaSection() {
  const multimedia = [
    {
      id: 1,
      title: "NFT Investing Fundamentals for Beginners",
      type: "video",
      thumbnail: "https://images.unsplash.com/photo-1614680376739-414d95ff43df?ixlib=rb-4.0.3&auto=format&fit=crop&w=1000&q=80",
      duration: "22:15",
      author: "Alex Morgan"
    },
    {
      id: 2,
      title: "How to Spot Promising NFT Projects Early",
      type: "video",
      thumbnail: "https://images.unsplash.com/photo-1618172193622-ae2d025f4032?ixlib=rb-4.0.3&auto=format&fit=crop&w=1000&q=80",
      duration: "18:40",
      author: "Sarah Chen"
    },
    {
      id: 3,
      title: "Weekly NFT Market Analysis Podcast",
      type: "podcast",
      thumbnail: "https://images.unsplash.com/photo-1620641788421-7a1c342ea42e?ixlib=rb-4.0.3&auto=format&fit=crop&w=1000&q=80",
      duration: "35:20",
      author: "Trading AI Team"
    },
    {
      id: 4,
      title: "The Future of NFTs in Gaming and Metaverse",
      type: "video",
      thumbnail: "https://images.unsplash.com/photo-1633265486501-b4d5c24f5a5a?ixlib=rb-4.0.3&auto=format&fit=crop&w=1000&q=80",
      duration: "27:45",
        ...
        {multimedia.map((media) => (
          <div key={media.id} className="bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden">
            <div className="h-40 relative">
              {!imageErrors[media.id] ? (
                ...
                <div className="w-full h-full bg-purple-100 dark:bg-purple-900 flex items-center justify-center">
                  <span className="text-purple-600 dark:text-purple-300 text-2xl font-bold">
            ...
            <div className="p-4">
              ...
              <Link
                href={`/learn/nft/multimedia/${media.id}`}
