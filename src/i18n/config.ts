...
const resources = {
  en: {
    translation: {
      ...
      willTriggerWhenPriceRisesTo: "Will trigger when price rises to ${{price}}",
      willTriggerWhenPriceFallsTo: "Will trigger when price falls to ${{price}}",
      tradingHistory: "Trading History",
      viewYourClosedPositions: "View your closed positions and trading performance",
      totalTrades: "Total Trades",
      totalProfit: "Total Profit",
      winRate: "Win Rate",
      searchSymbol: "Search by symbol",
      clearHistory: "Clear History",
      noHistoryYet: "No Trading History Yet",
      yourClosedPositionsWillAppearHere: "Your closed positions will appear here after you complete trades",
  ...
  fa: {
    translation: {
      ...
      hideW: "پنهان کردن نرخ برد",
      hideT: "پنهان کردن مجموع معاملات",
      hideP: "پنهان کردن سود و زیان",
      history: "تاريخچه",
      ...
      percent: "درصد",
      priceUsdt: "قیمت (USDT)",
      setLimits: "تنظیم حد سود و حد ضرر",
      download: "دانلود",
      tradeType: "نوع معامله",
      tradeMode: "حالت معامله",
      TP_SL: "TP/SL",
      internetConnectionWarning: "لطفاً از اتصال اینترنت و وجود VPN اطمینان حاصل کنید.",
      NoOpenTrade: "هیچ معامله‌ای باز نیست",
      searchPlaceholder: "جستجو بر اساس نام یا نماد...",
      sortByPrice: "مرتب‌سازی بر اساس قیمت",
      sortByMarketCap: "مرتب‌سازی بر اساس ارزش بازار",
      sortByVolume: "مرتب‌سازی بر اساس حجم",
      sortByChange: "مرتب‌سازی بر اساس تغییرات ۲۴ ساعته",
      ascending: "صعودی",
      descending: "نزولی",
      noResults: "نتیجه‌ای یافت نشد ☹️",
      market: "بازار",
      ...
      enterPercent: "درصد را وارد کنید",
      estimatedProfit: "سود تخمینی",
      estimatedLoss: "ضرر تخمینی",
      profitPercent: "درصد سود",
      lossPercent: "درصد ضرر",
      willTriggerWhenPriceRisesTo: "زمانی فعال می‌شود که قیمت به ${{price}} برسد",
      willTriggerWhenPriceFallsTo: "زمانی فعال می‌شود که قیمت به ${{price}} کاهش یابد",
      tradingHistory: "تاریخچه معاملات",
      viewYourClosedPositions: "مشاهده معاملات بسته شده و عملکرد معاملاتی شما",
      totalTrades: "کل معاملات",
      totalProfit: "سود کل",
      winRate: "نرخ موفقیت",
      searchSymbol: "جستجو بر اساس نماد",
      clearHistory: "پاک کردن تاریخچه",
      noHistoryYet: "هنوز تاریخچه معاملاتی وجود ندارد",
      yourClosedPositionsWillAppearHere: "ستظهر صفقاتك المغلقة هنا بعد إكمال الصفقات",
      closePrice: "قیمت بسته شدن",
      noActivePositions: "هیچ پوزیشن فعالی وجود ندارد",
      selectSymbol: "انتخاب نماد",
  ...
  ar: {
    translation: {
      ...
      sortByMarketCap: "ترتيب حسب القيمة السوقية",
      sortByVolume: "ترتيب حسب الحجم",
      sortByChange: "ترتيب حسب التغيير خلال 24 ساعة",
      ascending: "تصاعدي",
      descending: "تنازلي",
      noResults: "لم يتم العثور على نتائج ☹️",
      market: "السوق",
      ...
      estimatedLoss: "الخسارة المتوقعة",
      profitPercent: "نسبة الربح",
      lossPercent: "نسبة الخسارة",
      willTriggerWhenPriceRisesTo: "سيتم التفعيل عندما يرتفع السعر إلى ${{price}}",
      willTriggerWhenPriceFallsTo: "سيتم التفعيل عندما ينخفض السعر إلى ${{price}}",
      tradingHistory: "تاريخ التداول",
      viewYourClosedPositions: "عرض صفقاتك المغلقة وأداء التداول الخاص بك",
      totalTrades: "إجمالي الصفقات",
      totalProfit: "إجمالي الربح",
      winRate: "نسبة النجاح",
      searchSymbol: "البحث عن رمز",
      clearHistory: "مسح التاريخ",
      noHistoryYet: "لا يوجد تاريخ تداول بعد",
      yourClosedPositionsWillAppearHere: "ستظهر صفقاتك المغلقة هنا بعد إكمال الصفقات",
